...
import { socialPlatformIconComponent } from '@/lib/social-platform-icons';
import {
...
export function iconForSocialConnection(connection) {
  const platform = detectSocialPlatform(connection);
  const BrandIcon = socialPlatformIconComponent(platform);
